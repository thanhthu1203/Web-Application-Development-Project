...
// //   card.querySelector('.current-user-avatar').textContent = getInitials(getCurrentModFullName());
...
// //       wrapper.querySelector('.current-user-avatar').textContent = getInitials(getCurrentModFullName());
...
// //   } catch (err) { showToast('❌ interaction error'); }
// // }
...
//     // Tạo map với cả name và avatar - giống user_messages.js
//     const userMap = {};
//     users.forEach(u => {
//       userMap[u.user_id] = {
...
//       // Hiển thị avatar - có ảnh thì dùng ảnh, không thì dùng chữ cái (giống user_messages.js)
//       const avatar = wrapper.querySelector('.author-avatar');
//       if (depth > 0) avatar.classList.add('nested');
